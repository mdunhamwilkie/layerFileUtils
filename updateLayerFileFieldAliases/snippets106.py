...
# need to be made for compatibility with ArcGIS 10.6:
...
def GetLibPath():
    ...
    import _winreg
    keyESRI = _winreg.OpenKey(_winreg.HKEY_LOCAL_MACHINE, "SOFTWARE\\ESRI\\Desktop10.6")
...
def InitStandalone():
    ...
    if not pVM.LoadVersion(esriVersion.esriArcGISDesktop, "10.6"):
        return False
    # Get license
